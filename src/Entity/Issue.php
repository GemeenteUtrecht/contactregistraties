...
class Issue implements StringableInterface
{
	...
	/**
	 * Een uitgebreide beschrijvende tekst over dit Issue bedoeld ter verdere verduidelijking.  <br /><b>Schema:</b> <a href="https://schema.org/description">https://schema.org/description</a>
	 *
	 * @var string
	 *
	 * @ORM\Column(
	...
	*/
	...
	/**
	 * Het tijdstip waarop dit Issue object is aangemaakt
	 *
	...
	/**
	 * Het tijdstip waarop dit Issue object voor het laatst is gewijzigd.
	 *
	 * @var string Een "Y-m-d H:i:s" waarde bijvoorbeeld "2018-12-31 13:33:05" ofwel "Jaar-dag-maand uur:minuut:seconde"
